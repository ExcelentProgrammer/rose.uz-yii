    ...
    <div class="container mb30">
      ...
      <span
        ...
        <div class="row" style="padding-bottom: 40px;">
            ...
            <!--    <a-->
            <!--      href="https://bill.qiwi.com/order/external/create.action?comm=-->
            <?php //= $commentUrl ?><!--&from=584814&summ=-->
            <?php //= $model->getOrderTotalUsdPrice() ?><!--&currency=USD"-->
            ...
            <a href="<?= Url::to("octo/create") ?>" class="payment-btn paybox-btn">
            ...
            <?php //= $model->getOrderTotalUsdPrice() ?><!--">-->
                    ...
                    <div class="callback-modal-container">
                        <div class="row">
                            <div class="col-md-offset-2 col-md-8 paynet-text mb20">
                                <p>Чтобы оплатить через платёжную систему <strong>PAYNET</strong>, найдите ближайший
                                    пункт
